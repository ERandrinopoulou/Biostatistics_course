...
![](Introduction_files\\figure-beamer\\SS_R.PNG){ height="270px" }
...
## How does R work ?
  ...
  - Download R packages from the CRAN web site $\rightarrow$ within R
    ...
    + Install package(s)*
    + make you choice(s)
    + load the package using \texttt{\blue{library()}} (\textbf{\textcolor{red}{note}}: install does not mean load)

\vspace*{0.3cm}

\* use alternatively \texttt{\blue{install.packages()}}   
