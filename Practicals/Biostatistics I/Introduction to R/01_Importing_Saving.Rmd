...
<div id = "save2 class="collapse" style="border:1px; border-style:solid; padding: 1em; border-color:#6d79ac">
Use the function save(...). Note that you need to set the working directory.
</div>')
```
...
<div id = "load" class="collapse" style="border:1px; border-style:solid; padding: 1em; border-color:#6d79ac">
...
<div id = "rm" class="collapse" style="border:1px; border-style:solid; padding: 1em; border-color:#6d79ac">
Use the function rm(...).
</div>')
```
...
<div id = "rm2" class="collapse" style="border:1px; border-style:solid; padding: 1em; border-color:#6d79ac">
Use the function rm(...).
</div>')
```
